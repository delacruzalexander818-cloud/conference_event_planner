...
const mealsTotalCost = calculateTotalCost("meals");
    const navigateToProducts = (idType) => {
        if (idType == '#venue' || idType == '#addons' || idType == '#meals') {
          if (showItems) { // Verificar si showItems es falso
            setShowItems(!showItems); // Alternar showItems a verdadero solo si actualmente es falso
          }
        }
      }
      const totalCosts = {
    ...
    return (
        <>
            <navbar className="navbar_event_conference">
                <div className="company_logo">Planificador de Gastos de Conferencia</div>
        ...
        <div className="text">
          ...
          <h1>Selección de Salas de Evento</h1>
        </div>
